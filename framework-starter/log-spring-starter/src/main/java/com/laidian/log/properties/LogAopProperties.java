package com.laidian.log.properties;
...
public class LogAopProperties {
    ...
    private final String DEFAULT_EXPRESSION = "execution(public * com.laidian.erp.*.service.*.*(..)) || " +
            "execution(public * com.laidian.erp.*.controller.*.*(..)) || " +
            "execution(public * com.laidian.erp.*.mapper.*.*(..)) ";
